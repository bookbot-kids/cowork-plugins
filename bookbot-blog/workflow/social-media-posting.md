...
After a blog article is published to the Bookbot website (Phase 5), this guide:
...
This guide is called from Phase 6 of `blog-writing-workflow.md`, immediately after publication is confirmed in Step 5.4. The workflow passes forward:
...
The social media posting guide handles everything from there: image selection, hook generation, user review, and posting to all four platforms.
